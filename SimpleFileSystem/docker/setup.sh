...
if docker compose version &>/dev/null; then
    ...
    if command -v apt &>/dev/null; then
        ...
        docker run -d --name simplefs \
          -p 7674:7474 \
          -p 7689:7687 \
          -v $(pwd)/neo4j-data/simplefs1/data:/data \
          -v $(pwd)/neo4j-data/simplefs1/logs:/logs \
          -v $(pwd)/neo4j-data/simplefs1/backups:/backups \
          -v $(pwd)/neo4j-data/simplefs1/import:/var/lib/neo4j/import \
